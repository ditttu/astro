...
$sql09 = "SELECT ques2_time FROM users WHERE username = '$username'";
$retval09 = mysqli_query($link, $sql09);
		$row09 = mysqli_fetch_assoc($retval09);
		$ques1_time = $row09["ques2_time"];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//$Q1ans="adi";
		$sql4 = "UPDATE users SET Q2ans='$Q2ans' WHERE username = '$username'";
        //$conn=mysql_select_db('Astro');
...
<center><div class="w3-cell w3-mobile Text">Ques. 2</div></center>
</div>
<div class="w3-container form">
<center><div class="Question Text w3-cell-middle w3-mobile">Far far away on a well known piece of land... in the company of great men, there lives the divine one. His quests were unparalleled and changed the course of history. Such was his strength that his deeds brought light to most of what previously dark and shook the mighty thrones of gods. And in the end the great knight chose to lay peacefully. And yes he bore an incredible child, the one who rules heaven and earth alike. But he is grim. Some wise men warned him, of his child, the one who brings harmony to the chaotic cosmic realm... that his deeds will one day break all bonds and ties, and bring us to a great demise.
...
<div id="Hint1modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>The knight wasn’t a warrior</p>
    </div>
...
<div id="Hint2modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>His child won’t let you fly</p>
    </div>
  </div>

</div>
<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
<div class="columnfull w3-cell w3-mobile Text"><textarea class="inputbox" rows="3" name='Q2ans' id="answer" cols="110" placeholder="Answer"></textarea></div>
