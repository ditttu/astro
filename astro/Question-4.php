...
$sql09 = "SELECT ques4_time FROM users WHERE username = '$username'";
$retval09 = mysqli_query($link, $sql09);
		$row09 = mysqli_fetch_assoc($retval09);
		$ques1_time = $row09["ques4_time"];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//$Q1ans="adi";
		$sql4 = "UPDATE users SET Q4ans='$Q4ans' WHERE username = '$username'";
        //$conn=mysql_select_db('Astro');
...
<center><div class="w3-cell w3-mobile Text">Ques. 4</div></center>
</div>
<div class="w3-container form">
<center><div class="Question Text w3-cell-middle w3-mobile">The world has been cruel with me. I was young, beautiful and vulnerable. I just wanted to be divine but he fooled me. He, the powerful, disguised himself and so I permitted him, I thought I’m serving my idol but I was fooled. And what not, I was transformed, I was punished for a mistake that wasn’t entirely mine. Even the one, whom I gave a form, didn’t recognise me. And we were placed far far away, at a cold and austere place, so we could never ever meet again…<br>

And now you are forcing me to live with the one who destroyed me...and his mistress enjoys telling you all about this.. Humanity will be cursed…
<br>
-What am I talking about?<br>
-Tell me the names of all the associated objects and structures. <br>
-Tell me qualitatively why they both can never meet. <br>
-Who is the powerful one??<br>
- His mistress??<br>
...
<div id="Hint1modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>Astronomy is one of the oldest science. Think of the one dominant thing with which people used to associate anything in ancient times.
</p>
   <div class="column  w3-cell w3-mobile"><button id="H2" style="vertical-align:middle" class="button1"><span>Hint 2</span></button></div>
    </div>
  </div>
...
<div class="columnfull w3-cell w3-mobile Text"><textarea class="inputbox" rows="3" name='Q4ans' id="answer" cols="110" placeholder="Answer"></textarea></div>
<div class="column Text">Marks-80</div>
