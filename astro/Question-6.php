...
$retval3 = mysqli_query($link, $sql3);}
		...
		$currentques = $row["currentques"];if($currentques!=6){
...
$sql09 = "SELECT ques6_time FROM users WHERE username = '$username'";
$retval09 = mysqli_query($link, $sql09);
		$row09 = mysqli_fetch_assoc($retval09);
		$ques1_time = $row09["ques6_time"];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//$Q1ans="adi";
		$sql4 = "UPDATE users SET Q6ans='$Q6ans' WHERE username = '$username'";
        //$conn=mysql_select_db('Astro');
...
<center><div class="w3-cell w3-mobile Text">Ques. 6</div></center>
</div>
<div class="w3-container form">
<center><div class="Question Text w3-cell-middle w3-mobile">“I’m fond of histories, and hence it ain’t my choice,<br>
 Greatest of the kings uttered, upon his demise, <br>
 To his son, for he should know the truth and the light,<br>
 To take his kingdom to the greatest of height.<br>
 But since antiquity great men have held the truth,<br>
 So did the emperor as he died and, in his native spoke,<br>
 “Jredfnwrwkhehjlqqlqj”   .... and then he died…”<br>
 (I mean that’s what I heard.. btw.. I was there ;))<br>


Crack the code for me, and tell me the source of the great truths, as it’ll help me rule your world. Ironic ain’t it :))<br>
...
<div id="Hint1modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>The cipher key is in his name.
...
<div id="Hint2modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>He spoke in his language of gods and nobility but I have told it to you in mine.
</p>
    </div>
  </div>
...
<div class="columnfull w3-cell w3-mobile Text"><textarea class="inputbox" rows="3" name='Q6ans' id="answer" cols="110" placeholder="Answer"></textarea></div>
