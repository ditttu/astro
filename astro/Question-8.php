...
$sql09 = "SELECT ques8_time FROM users WHERE username = '$username'";
$retval09 = mysqli_query($link, $sql09);
		$row09 = mysqli_fetch_assoc($retval09);
		$ques1_time = $row09["ques8_time"];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//$Q1ans="adi";
		$sql4 = "UPDATE users SET Q8ans='$Q8ans' WHERE username = '$username'";
        //$conn=mysql_select_db('Astro');
...
<center><div class="w3-cell w3-mobile Text">Ques. 8</div></center>
</div>
<div class="w3-container form">
<center><div class="Question Text w3-cell-middle w3-mobile">If some of you believe that there was a creator of the universe, I can assure you… that that creator is poor in shooting. Who the hell shoots so random shots in one’s own elegant creation and what more… leave them unattended for us to mock ^_^.  We can still see the gunshots bleed, bleed a lot !!.<br>

Let me laugh now while you tell me the names of those two gunshots near each other.<br>
...
<div id="Hint2modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>Relate with a subtype of handgun.
</p>
    </div>
  </div>
...
<div class="columnfull w3-cell w3-mobile Text"><textarea class="inputbox" rows="3" name='Q8ans' id="answer" cols="110" placeholder="Answer"></textarea></div>
