...
$sql09 = "SELECT ques9_time FROM users WHERE username = '$username'";
$retval09 = mysqli_query($link, $sql09);
		$row09 = mysqli_fetch_assoc($retval09);
		$ques1_time = $row09["ques9_time"];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//$Q1ans="adi";
		$sql4 = "UPDATE users SET Q9ans='$Q9ans' WHERE username = '$username'";
        //$conn=mysql_select_db('Astro');
...
<center><div class="w3-cell w3-mobile Text">Ques. 9</div></center>
</div>
<div class="w3-container form">
...
CO + H2O → CO2 + H2<br>
(83 ± 3%  H2)<br>
<center><image src="Question9img.jpeg" height="50%" width="50%"></image></center><br>
Deacon process<br>

4 HCl + O2 → 2 Cl2 + 2 H2O<br>
(Pale green/cyan colour gas produced)<br>

Doctor Strange thus gave me this strange combination and instructed me to prepare a starship. Then he went away as swift as lightning and uttered these words…<br>

“Meet me with your ship, at the place where I intend and... I’ll tell you the secret to the hidden dimensions of the universe.”<br>

Now this will cost a lot of money. Now you know what to do... figure out from somewhere how much my mission will cost??<br>
...
<div id="Hint1modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>Doctor strange is interested not in the reactions and chemicals but in the results. 
...
<div id="Hint2modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
		<p>What he intend is an ancient god too.
...
<div class="columnfull w3-cell w3-mobile Text"><textarea class="inputbox" rows="3" name='Q9ans' id="answer" cols="110" placeholder="Answer"></textarea></div>
